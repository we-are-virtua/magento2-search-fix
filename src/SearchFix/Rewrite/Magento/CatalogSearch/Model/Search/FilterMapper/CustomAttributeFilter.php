...
namespace Virtua\SearchFix\Rewrite\Magento\CatalogSearch\Model\Search\FilterMapper;
...
use Magento\CatalogSearch\Model\Search\FilterMapper\CustomAttributeFilter as CoreCustomerAttributeFilter;

class CustomAttributeFilter extends CoreCustomerAttributeFilter
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($resourceConnection, $conditionManager, $eavConfig, $storeManager, $aliasResolver);
